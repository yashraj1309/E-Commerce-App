...
export default function ProductSubCard({ params }: { params: { id: string } }) {
  ...
  return (
    <div style={{ margin: "4.5rem 1rem auto 1rem" }} key={product.id}>
      <div className="sub-product-main">
        ...
        <div className="sticky-product-detail">
          <div className="sticky-detail-child">
            ...
            <button
              type="button"
              className="btn btn-success custom-btn-product"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
